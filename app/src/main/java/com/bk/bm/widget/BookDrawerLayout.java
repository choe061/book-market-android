...
public class BookDrawerLayout extends DrawerLayout {

    private static final int MIN_DRAWER_MARGIN = 0; // dp

    public BookDrawerLayout(Context context) {
        super(context);
    }

    public BookDrawerLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BookDrawerLayout(Context context, AttributeSet attrs, int defStyle) {
